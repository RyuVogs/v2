...
#install cf
wget https://raw.githubusercontent.com/ryuvogs/v2/main/Fls/cf.sh && chmod +x cf.sh && ./cf.sh
rm -f /root/cf.sh
clear
else
...
WantedBy=multi-user.target
EOF
#wget https://raw.githubusercontent.com/baku/cc/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
#clear
cd
wget -q -O /usr/local/sbin/quota "https://raw.githubusercontent.com/rajaganjil93/cc/main/limit/quota"
chmod +x /usr/local/sbin/quota
cd /usr/local/sbin/
sed -i 's/\r//' quota
clear
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/rajaganjil93/cc/main/limit/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
clear
wget -q -O /usr/bin/limit-ip-ssh "https://raw.githubusercontent.com/rajaganjil93/cc/main/limit/limit/limit-ip-ssh"
chmod +x /usr/bin/*
cd /usr/bin
...
wget -q -O /etc/websocket/ws.py "https://raw.githubusercontent.com/ryuvogs/v2/main/Fls/ws.py"
...
type = drive
scope = drive
token = {"access_token":"ya29.a0AXooCgtXG6RN1eFabN7wcX5Sn5zbcmcerx4ARGlGEIdkbKGqIkR9_Z5-JGywV8050o8Lm622K7AivoPkrgo4NtkvKjRxFBm2lopxuBhG3zzx0S1d9ShhEWJruDSlrDqZcaInzLaP5Jb69NUmdpdIhWX-phjhw25X0S7YaCgYKAVgSARESFQHGX2MiRqBEXqJY4IdCc0mb3uspxg0171","token_type":"Bearer","refresh_token":"1//0gsLrdeI11-dUCgYIARAAGBASNwF-L9Ir8CfRSvi9nkCwmvOqwoYP_NHdiy3FZObbPhj3o3YTueeLA6UeBOq92BH_LS9NlbWDziw","expiry":"2024-06-26T12:49:15.503232337Z"}
EOF
...
insdns() {
#wget ${repo}slow/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}
...
UDP="https://raw.githubusercontent.com/rajaganjil93/cc/main/"
# install udp-custom
