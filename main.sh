...
wget -q https://raw.githubusercontent.com/ryuvogs/v2/main/Vpn/update.sh && chmod +x update.sh && ./update.sh
...
echo  ""
sleep 4
echo -e "⏳ Reboot Otomatis dalam 5 detik..."
sleep 5
reboot
