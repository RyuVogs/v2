...
# Langkah Awal Menambahkan domain untuk semua protokol
function add_domain() {
echo -e ""
clear
echo -e "   .----------------------------------."
...
insbkp() {
wget -q https://raw.githubusercontent.com/rajaganjil93/cc/main/limit/installbckp.sh && chmod +x installbckp.sh && ./installbckp.sh
clear
}
...
insdns() {
#wget https://raw.githubusercontent.com/rajaganjil93/cc/main/slow/installsl.sh && chmod +x installsl.sh && bash installsl.sh
#clear
}
...
insmenu() {
wget -q https://raw.githubusercontent.com/rajaganjil93/up/main/c1/up.sh && chmod +x up.sh && ./up.sh
clear
}
...
USRID=$(curl https://raw.githubusercontent.com/cibut2d/reg/main/ip | grep $ipsaya | awk '{print $2}')
USREXP=$(curl https://raw.githubusercontent.com/cibut2d/reg/main/ip | grep $ipsaya | awk '{print $3}')
TIME=`date -d "0 days" +"%d-%m-%Y" `
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>────────────────────</code>
<b>⚠️AUTOSCRIPT JULAK BANTUR V1⚠️</b>
<code>────────────────────</code>
...
main() {
    ...
    2)
      echo -e ""
      echo -e "${RED}Trial sudah tidak tersedia sayangku !${FONT}"
      echo -e ""
        ;;
    *)
        rm -rf v1.sh
